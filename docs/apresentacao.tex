...
\title[MyStreet] % (optional, use only with long paper titles)
{MyStreet}

\subtitle
{Rede social para parttilha de informação sobre infraestruturas} % (optional)

\author[Li4] % (optional, use only with lots of authors)
{Bruno Matos \\ Carlos Cosio \\ Jorge Rodrigue \\ Miguel Fernandes \\ Rui Silva}
